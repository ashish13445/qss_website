...
<nav class="bg-white md:fixed  md:z-10 md:top-0 md:w-full subpixel-antialiased tracking-wide	">
  <div class="mx-auto  pt-4 px-2 sm:px-6 lg:px-8 bg-white" >
    <div class="relative md:flex h-12 md:h-16 md:items-center justify-between border-b-2 md:border-0 ">
      ...
      <div class="md:hidden">
      <div class="flex justify-between items-center h-10 px-4 sm:px-6 lg:px-8 bg-white">
        <!-- Logo -->
        <div class="flex-shrink-0">
          <ApplicationLogo />
        </div>
        <!-- Mobile Menu Button -->
        <button @click="toggleMobileMenu" type="button" class="inline-flex justify-center items-center w-10 h-10 text-black hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
          <!-- Icon -->
